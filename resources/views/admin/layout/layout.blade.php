      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ url(asset('backend/assets/img/user8-128x128.jpg'))}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ url(asset('backend/assets/img/user3-128x128.jpg'))}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
...
<!-- jQuery Knob Chart -->
<script src="{{ url(mix('backend/assets/plugins/jquery-knob/jquery.knob.js')) }}"></script>
<!-- daterangepicker -->
...
<!-- overlayScrollbars -->
<script src="{{ url(mix('backend/assets/plugins/plugins/overlayScrollbars/js/jquery.overlayScrollbars.js')) }}"></script>
<!-- AdminLTE App -->
